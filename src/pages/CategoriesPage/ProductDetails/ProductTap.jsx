      ...
      <div className="border border-gray-200">
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600">العارضة (بطول 5'8") ترتدي مقاس S</p>
          </div>
          <div>
            <h3 className="text-lg font-bold">الخامة والعناية:</h3>
            <p className="text-gray-600">قماش القميص: قطن نقي</p>
            <p className="text-gray-600">قماش البنطال: قطن نقي</p>
            <p className="text-gray-600">غسل يدوي</p>
          </div>
        </div>
      </div>
    </section>
