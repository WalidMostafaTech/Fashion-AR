...
const Colors = () => {
  ...
  return (
    <div className="border border-gray-clr2 p-4 text-center space-y-4 h-fit">
        ...
        {colors.map((color, index) => (
          <img
            ...
            className={`w-22 h-22 border-2 p-1 rounded cursor-pointer ${
              selectedColor === index ? "border-main-clr" : "border-gray-clr2"
            }`}
          />
        ))}
      </div>

      <div className="flex items-center justify-center gap-2 bg-gray-clr2 p-2 mx-auto w-fit">
        <button
      ...
      <div className="flex justify-center gap-2">
        <button
          disabled
          className="bg-gray-clr text-gray-clr3 px-4 py-1 rounded line-through cursor-not-allowed"
        >
          غير متوفر
        </button>
      ...
      <div className="flex justify-center gap-4 text-gray-clr3 mt-2">
